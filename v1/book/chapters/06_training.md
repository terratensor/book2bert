...
### 6.1 Что такое эпоха в нашем эксперименте

Эпоха — один полный проход всех 3.9M примеров через модель. За 5 эпох каждый пример был показан модели 5 раз.

Для сравнения: оригинальный BERT-base обучался ~40 эпох, каждый пример видел ~40 раз. Разница в 8 раз объясняет, почему наша модель еще не выучила редкие словоформы — ей нужно больше эпох или больше данных.
